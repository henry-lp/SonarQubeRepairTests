...
public class BigDecimalDoubleConstructor {
    ...
    public void main2(String[] args) {
        ...
        BigDecimal bd2 = BigDecimal.valueOf(2.0);// Noncompliant {{Use "BigDecimal.valueOf" instead.}}

        BigDecimal bd4 = new BigDecimal("2.0", mc);// Noncompliant {{Use "BigDecimal.valueOf" instead.}}

        BigDecimal bd5 = BigDecimal.valueOf(2.0F);// Noncompliant {{Use "BigDecimal.valueOf" instead.}}

        BigDecimal bd6 = new BigDecimal("2.0", mc);// Noncompliant {{Use "BigDecimal.valueOf" instead.}}
    ...
    public void foo(String[] args) {
        ...
        float f = 2.2;
        float f1 = 2.0F;
        BigDecimal bd3 = BigDecimal.valueOf(f);// Noncompliant

        BigDecimal bd4 = BigDecimal.valueOf(f1);// Noncompliant
